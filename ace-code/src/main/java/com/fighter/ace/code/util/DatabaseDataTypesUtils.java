...
public class DatabaseDataTypesUtils {
    ...
    public static boolean isFloatNumber(String javaType) {
        return !javaType.endsWith("Float") && !javaType.endsWith("Double") && !javaType.endsWith("BigDecimal") && !javaType.endsWith("BigInteger")?javaType.endsWith("float") || javaType.endsWith("double") || javaType.endsWith("BigDecimal") || javaType.endsWith("BigInteger"):true;
    }

    public static boolean isIntegerNumber(String javaType) {
        return !javaType.endsWith("Long") && !javaType.endsWith("Integer") && !javaType.endsWith("Short") && !javaType.endsWith("Byte")?javaType.endsWith("long") || javaType.endsWith("int") || javaType.endsWith("short") || javaType.endsWith("byte"):true;
    }
    ...
    public static String getPreferredJavaType(int sqlType, int size, int decimalDigits) {
        if((sqlType == 3 || sqlType == 2) && decimalDigits == 0) {
            return size == 1?"java.lang.Boolean":(size < 3?"java.lang.Byte":(size < 5?"java.lang.Short":(size < 10?"java.lang.Integer":(size < 19?"java.lang.Long":"java.math.BigDecimal"))));
        } else {
    ...
    static {
        ...
        _preferredJavaTypeForSqlType.put(-7, (String)"java.lang.String");
        _preferredJavaTypeForSqlType.put(16, (String)"java.lang.String");
