...
import com.fighter.ace.framework.common.fck.Command;
import com.fighter.ace.framework.common.fck.ResourceType;
import com.fighter.ace.framework.common.fck.UploadResponse;
import com.fighter.ace.framework.common.fck.Utils;
...
import com.fighter.ace.framework.common.upload.UploadUtils;
    ...
    private UploadResponse doUpload(HttpServletRequest request, String typeStr,
        ...
        try {
            ...
            /*if (site.getConfig().getUploadToDb()) {
                ...
                if (mark && isImg) {
                    File tempFile = mark(uplFile, conf);
                    fileUrl = fileRepository.storeByExt(CmsUtil.getUploadPath(),
                            ext, tempFile);
                    tempFile.delete();
                } else {
                    fileUrl = fileRepository.storeByExt(CmsUtil.getUploadPath(),
