jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        accept: {
            ...
            mimeTypes: 'image/*,application/vnd.ms-pki.stl'
        },
        ...
        switch ( state ) {
            ...
            case 'finish':
                ...
                if ( stats.successNum ) {
                    ...
                    //alert(uploader.getFiles('complete'));
                    //$('#uploadFiles').val(uploader.getFiles('complete'))
                } else {
                    // 没有成功的图片，重设
                    state = 'done';
                    location.reload();
    ...
    uploader.onUploadSuccess = function(file,response){
        ...
        var val = $('#uploadFiles').val();
        if(val != null && val != ''){
            val = val +',' + response._raw ;
        } else {
            val = response._raw;
        }
        $('#uploadFiles').val(val);
