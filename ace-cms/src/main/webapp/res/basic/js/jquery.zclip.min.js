...
(function (a) {
    a.fn.zclip = function (c) {
        if (typeof c == "object" && !c.length) {
            var b = a.extend({path: "/res/basic/swf/ZeroClipboard.swf", copy: null, beforeCopy: null, afterCopy: null, clickAfter: true, setHandCursor: true, setCSSEffects: true}, c);
            return this.each(function () {
                ...
                if (e.is(":visible") && (typeof b.copy == "string" || a.isFunction(b.copy))) {
                    ...
                    if (a.isFunction(b.fun)) {
                        e.bind("zClip_fun", b.fun)
                    }
                    ...
                    d.addEventListener("complete", function (f, g) {
                        if (a.isFunction(b.afterCopy)) {
                            ...
                            //qianfeng 2017-02-09 改 可自定义提示框 fun:function(){提示框内容}
                            if (b.fun) {
                                e.trigger("zClip_fun")
                            }else{
                                alert(b.title+"\n\n"+g);
